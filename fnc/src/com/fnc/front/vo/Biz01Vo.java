...
public class Biz01Vo {
	
	private String gubun1;
	private String gubun2;
	private String nmPdct;
	private String atrb2;
	private String atrb3;
	private String atrb4;
	...
	public String toString() {
		return "Biz01Vo [gubun1=" + gubun1 + ", gubun2=" + gubun2 + ", nmPdct=" + nmPdct + ", atrb2=" + atrb2
				+ ", atrb3=" + atrb3 + ", atrb4=" + atrb4 + ", noAtchFileSral=" + noAtchFileSral + ", fileList="
				+ fileList + "]";
	}
