...
import com.fnc.admin.dao.PerDao;
...
public class PerAction extends BaseAction {
	...
	private static Logger logger = Logger.getLogger(PerAction.class);
	PerDao dao = new PerDao();
	FileDao fileDao = new FileDao();
	
	// 객체 변수
	private PerVo resultVo;
	private List<PerVo> resultList;
	private int cnt; 
	...
	public PerVo getCarVo() {
		return resultVo;
	}
	
	public List<PerVo> getResultList() {
		return resultList;
	}
	
	public PerVo getResultVo() {
		return resultVo;
	}

	public void setResultVo(PerVo resultVo) {
		this.resultVo = resultVo;
	}

	public void setResultList(List<PerVo> resultList) {
	...
	//개인정보 등록
	public String perRegiExcute() throws Exception {
	...
	public String listAjax() throws Exception {
		...
		this.cnt = dao.selectPerListCnt(paramMap);
		this.resultList = dao.selectPerList(paramMap);
	...
	public String modi() throws Exception {
		...
		logger.debug(getMap());
		this.resultVo = dao.selectPer(paramMap);
		this.fileVoList= fileDao.selectFileList(resultVo.getNoAtchFileSral());
		return SUCCESS;
	}
	
	public String perModiExcute() throws Exception {
