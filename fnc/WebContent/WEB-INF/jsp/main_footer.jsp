<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%
  String ctx2 = request.getContextPath(); //콘텍스트명 얻어오기.
	...
	<footer>
		<div class="ft-top">
			<div class="innerwrap">
				<div class="footMenu">
					<ul>
						<li><a href="#customer_view" onclick="sendEmail()">고객문의</a></li>
...
function changeCaptcha() {
   ...
   $('#catpcha').html('<img src="<%=ctx2%>/captcha/CaptChaImg.jsp?rand='+ Math.random() + '"/>');
}
...
if ( !$('#answer').val() ) {
    ...
    $.ajax({
        url: '<%=ctx2%>/captcha/CaptchaSubmit.jsp',
        type: 'POST',
        dataType: 'text',
