...
<%@include file="/WEB-INF/jsp/admin/adm_header.jsp"%>
	...
	<div id="container">
		...
		<div id="contents">
			<h2>회사소식관리</h2>
			<form id="frm" action="modiExcute.do" method="POST" enctype="multipart/form-data">
					...
					<table class="tblwrite">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<textarea class="textarea-basic" id="cntsSmry" name="cntsSmry">${resultVo.cntsSmry}</textarea>
								</td>
							</tr>
							<tr>
