...
<%@include file="/WEB-INF/jsp/admin/adm_header.jsp"%>
	...
	<div id="container">
		...
		<div id="contents">
			...
			<form id="frm" action="carRegiExcute.do" method="POST" enctype="multipart/form-data">
			<div class="gridwrap">
				<div class="hd_txt">
				...
				<table class="tblwrite">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="text" id="dtBegnc" name="dtBegnc" class="datepicker dateType" readOnly> <span class="hipn">~</span> <input type="text" id="dtEnd" name="dtEnd" class="datepicker dateType" readOnly>
							</td>
						</tr>
						<tr>
