...
<%@include file="/WEB-INF/jsp/admin/adm_header.jsp"%>
	...
	<div id="container">
		...
		<div id="contents">
			...
			<div class="search">
				<fieldset>
					...
					<select id="searchStat" name="searchStat" class="srhoption">
						<option value="0" selected="selected">진행상태</option>
			...
			<div class="gridwrap">
				...
				<div class="list-btr al-right">
					<a href="/admin/carRegi.do" class="btn btn-submit">등록</a>
				</div>
		...
		<form id="delFrm" action="carDele.do">
        ...
        success: function(data) {
        	...
        	if(data.resultList != null && data.resultList.length>0){
        		for(var i = 0; i < data.resultList.length; i++){
		        	...
		        	html += '	<td>' + ynNtcNm  + '</td>';
		        	html += '	<td><a href="/admin/carModi.do?noNtcPlteSral=' + data.resultList[i].noNtcPlteSral + '" class="btn btn-prim">수정</a></td>';
		        	html += '	<td><a href="javascript:;" class="btn btn-secon" onclick="javascript:carDel('+ data.resultList[i].noNtcPlteSral +'); return false;">삭제</a></td>';
		        	html += '</tr>';
        		}
