...
<%@include file="/WEB-INF/jsp/admin/adm_header.jsp"%>
	...
	<div id="container">
		...
		<div id="contents">
			...
			<h2>제품관리</h2>
			<form id="frm" action="/admin/bizModiExcute.do" method="POST" enctype="multipart/form-data">
			...
			<div class="gridwrap">
				...
				<tr>
					<th>상세용도</th>
					<td>
						<textarea class="textarea-basic" id="atrb2" name="atrb2" >${resultVo.atrb2}</textarea>
					</td>
				</tr>
				<tr>
					<th>두께</th>
				...
				<tr>
					<th>표면처리</th>
					<td>
						<input type="text" id="atrb4" name="atrb4" class="iptful" placeholder="" value="${resultVo.atrb4}">
					</td>
				</tr>
				<tr>
					<th>첨부파일</th>
